...
public class RunJade {
	...
	/** 
        * This constructor starts a Main-Container or Container Jade. 
* 
* @Param cuInterfata when this parameter is set to true it starts RMA agent that controls the interface Jade. valid only if the main == true. 
* @Param main when this parameter is set to true container serves as MainContainer. So it starts a new platform. 
* @Param host ip or name of the computer that runs the Main-Container platform that wants to connect. valid only for main == false. 
* @Param port that runs hostPort indicate the main container 
* @Param port the port  running jade on this car (whether it is Main-Container or Booster) 
*/
	 ...
	 * 
	* @Param cuInterfata when this parameter is set to true it starts RMA agent that controls the interface Jade. 
        * @Param port the port Indica running jade on this car
	 * 
	 */
